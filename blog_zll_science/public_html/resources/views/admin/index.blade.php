...
@section('content')
	...
	<div class="top_box">
		<div class="top_left">
			...
			<ul>
				<li><a href="{{url('admin/info')}}" class="active" target="main">后台</a></li>
				<li><a href="/" target="blank" >前台</a></li>
			</ul>
		</div>
		<div class="top_right">
			<ul>
		...
		<ul>
            ...
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="{{url('/admin/confs')}}" target="main"><i class="fa fa-fw fa-cogs"></i>网站配置</a></li>
	...
	<div class="bottom_box">
		CopyRight © 2015. Powered By <a href="http://www.zll.science">http://www.zll.science</a>
	</div>
	<!--底部 结束-->
@endsection('content')