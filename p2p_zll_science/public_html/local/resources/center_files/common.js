...
(function(){
	...
	function toolbar(){
		var html = "<div class='floatbox01'>"+"<a href='http://www.niwodai.com/daikuan/jiekuan.html' rel='nofollow'  class='linka daikuan' target='_blank'>&nbsp;</a>"+"<a href='/userFeedback/opinion.html' rel='nofollow'  class='linka feedback' target='_blank'>&nbsp;</a>"+"<a id='onlineQQService' rel='nofollow'  class='linka onlineqq'>&nbsp</a>"+
	...
	//			"<i></i>&nbsp</a>"+
	//			"<a href='javascript:;' rel='nofollow' class='back-top' rel='nofollow'  id='tbar' style='display:none; z-index:9999'><i></i></a></div>";
		var html2 = "<div class='floatbox02'>"+"<a href='/daikuan/jiekuan.html' rel='nofollow'  class='linka daikuan' target='_blank'>&nbsp;</a>"+"<a href='/userFeedback/opinion.html' rel='nofollow'  class='linka feedback' target='_blank'>&nbsp;</a>"+"<a id='onlineQQService' rel='nofollow'  class='linka onlineqq'>&nbsp</a>"+
		"<a href='javaScript:;' rel='nofollow'  class='linka onlinewx' style='cursor:default'><i><em>&nbsp;</em>关注微信公众号“你我贷”。随时随地尊享一对一客服服务，您就是我们的VIP。</i></a>"+
		"<a href='javaScript:;' rel='nofollow' class='back-top' rel='nofollow'  id='tbar' style='display:none; z-index:9999'><i></i></a></div>";
...
$(function(){
	...
	$("#onlineQQService,#onlineQQService1").click(function(){
		...
		var buttonStr="uuid="+uuid+"&uid=null&t=button&src="+src+"&cid="+ encodeURIComponent(channel)+"&sr="+sw+"_"+sh+""+"&bp="+bw+"_"+bh+
				"&cookie="+isSetCookie+"&refer="+encodeURIComponent(referer)+"&cururl="+encodeURIComponent(cururl)+"&pagetype=null&time="+new Date().valueOf()+"&buttonid=onlineQQService";
