				...
				<div class="clearfix nwd_loginOut">
                    ...
                    <div class="content_box pb_20">
						<label class="input_text yzm3">
							<input type="text" class="inp_bor inpIco3" placeholder="手机号" id="u" name="mobile" value="{{old('mobile')}}">
						</label>
                        <label class="input_text yzm3">
							<input type="text" class="inp_bor inpIco3" placeholder="用户名" id="uname" name="name" value="{{old('name')}}">
						</label>
                        <label class="input_text yzm3">
							<input type="text" class="inp_bor inpIco3" placeholder="Email" id="email" name="email" value="{{old('email')}}">
						</label>
                        <label class="input_text yzm3">
						...
						<label class="input_text yzm3"><i class="fr yzm_img"><img width="80" height="32" src="{{url('/imgcode')}}?id=1" onclick='fn()' id="imgc"></i>
...
<script>
	function fn(){
		document.getElementById('imgc').src="{{url('/imgcode')}}?id="+Math.random();
		console.log(document.getElementById('imgcode'));
	}
