    ...
    <div class="clearfix main_wrapper">
    	<div class="container">
            <div class="accountCenter">
                <span class="fs_18 left">投资记录</span>
                    ...
                    <div class="clearfix tab_content">
                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                   <td class="f">{{$i += 1}}</td>
                                   <td class="tr"><span>{{$t->title}}</span></td> 
                                   <td class="tr">{{$t->money/100}}元</td>
                                   <td class="">@if($t->status == 0)审核中
                                    @elseif($t->status == 1)招标中
                                    @elseif($t->status == 2)还款中
                                    @elseif($t->status == 3)结束
                                    @endif</td>
                                   <td class="tr">{{date('Y-m-d', $t->pubtime)}}</td> 
                                </tr>
                                @endforeach
                                @else
