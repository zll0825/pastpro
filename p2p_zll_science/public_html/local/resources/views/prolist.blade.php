                        ...
                        <div class="clearfix nr">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                   ...
                                   <td>{{date('Y/m/d H:i', $pro->pubtime)}}</td> 
                                   <td class="tr"><span>{{$pro->name}}</span></td> 
                                   <td class="tr">{{$pro->money/100}}</td> 
                                   <td>{{$pro->age}}</td>
                                   <td class="tr">{{$pro->mobile}}</td>
                                   <td class="">@if($pro->status == 0)审核中
                                    @elseif($pro->status == 1)招标中
                                    @elseif($pro->status == 2)还款中
                                    @elseif($pro->status == 3)结束
                                    @endif</td>
                                   <td class="l">
                                    @if($pro->status == 0)
                                    <a href='{{url("/check/$pro->pid")}}'>审核</a>
                                    @else
                                    已审核
                                    @endif
                                    </td>
