                    ...
                    <div class="pro_bor">
                        ...
                        <ul class="clearfix pro_list_box">
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{$p->money/100}}</p>
                            </li>
                            <li class="w4">
                                <span class='b_jingdu b_jd{{sprintf("%d",$p->receive/$p->money*100)}}'>{{sprintf("%.2f",$p->receive/$p->money*100)}}%</span>
                            </li>
                            <li class="w5">
                                    <a class="btn btnSize_1 btn_orange" href="{{url('touzi',['pid'=>$p->pid])}}">立即投标</a>
                            </li>
                        </ul>
                        @endforeach
                    </div>
