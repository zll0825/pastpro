...
<!--left nav end-->
    ...
    <div class="clearfix main_wrapper">
    	<div class="container">
            ...
            <form method=post action="http://shop.com/test/index.php">
               
                <p>商户号:<input type=text name=v_mid value="{{$v_mid}}"></p>                  
                <p>订单号:<input type=text name=v_oid value="{{$v_oid}}"></p>
                <p>金额:<input type=text name=v_amount value="{{$v_amount}}"></p>                  
                <p>币种:<input type=text name=v_moneytype value="{{$v_moneytype}}"></p>               
                <p>网银回调url地址:<input type=text name=v_url value="{{$v_url}}"></p>
                <p>md5码:<input type=text name=v_md5info value="{{$v_md5info}}"></p> 
