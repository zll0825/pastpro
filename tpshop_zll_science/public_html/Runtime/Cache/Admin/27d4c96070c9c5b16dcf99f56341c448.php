...
<h1>
<span class="action-span"><a href="<?php echo U('Admin/cat/catadd');?>">添加分类</a></span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  <tr>
    ...
    <td align="left" class="first-cell" style = 'padding-left="0"'>
            ...
            <span><a href="#" ><?php echo (str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;",$c["lev"])); echo ($c["cat_name"]); ?></a></span>
        </td>
    <td width="10%">0</td>
    ...
    <td width="24%" align="center">
      <a href="#">转移商品</a> |
      <a href="<?php echo U('Admin/cat/catedit',array('cat_id'=>$c[cat_id]));?>">编辑</a> |
      <a href="<?php echo U('Admin/cat/catdel',array('cat_id'=>$c[cat_id]));?>" title="移除">移除</a>
