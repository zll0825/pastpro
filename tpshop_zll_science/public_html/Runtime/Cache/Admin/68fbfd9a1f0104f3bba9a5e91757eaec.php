...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td align="center"><span >100</span></td>
      ...
      <a href="<?php echo U('Admin/goods/goodsedit', array('id'=>$g[goods_id]));?>" title="编辑"><img src="/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('Admin/goods/goodsdel', array('id'=>$g[goods_id]));?>"  title="回收站"><img src="/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
