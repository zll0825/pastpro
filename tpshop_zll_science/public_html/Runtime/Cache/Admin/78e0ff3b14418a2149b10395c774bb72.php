...
<link href="/3.29/Public/Admin/css/general.css" rel="stylesheet" type="text/css" />
<link href="/3.29/Public/Admin/css/main.css" rel="stylesheet" type="text/css" />
      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          <tr>
            ...
            <td><input type="text" name="goods_name" value="<?php echo ($goods["goods_name"]); ?>" style="float:left;color:;" size="30" /></td>
          </tr>
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/3.29/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
          ...
          <tr>
            ...
            <td><select name="cat_id"  ><option value="0">请选择...</option>
              <?php if(is_array($cats)): foreach($cats as $key=>$c): ?><option value="<?php echo ($c["cat_id"]); ?>" <?php if($c[cat_id] == $goods[cat_id]): ?>selected<?php endif; ?>><?php echo (str_repeat("&nbsp;",$c["lev"])); echo ($c["cat_name"]); ?></option><?php endforeach; endif; ?>
            </select>
             </td>
          </tr>
                   <tr>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            <td class="label"><a href="#" title="点击此处查看提示信息"><img src="/3.29/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/3.29/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
