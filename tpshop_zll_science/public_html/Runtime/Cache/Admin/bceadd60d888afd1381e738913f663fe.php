      ...
      <tr>
        ...
        <td>
          <select name="parent_id">
                        ...
                        <?php if(is_array($cats)): foreach($cats as $key=>$c): ?><option value="<?php echo ($c["cat_id"]); ?>" <?php if($c[cat_id] == $cat[cat_id]): ?>selected<?php endif; ?>><?php echo (str_repeat("&nbsp;", $c["lev"])); echo ($c["cat_name"]); ?></option><?php endforeach; endif; ?>
                      </select>
        </td>
      </tr>
