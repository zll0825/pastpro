...
<div class="content">
	<div class="user">
		...
		<div class="shop">
			<div class="linebt"><span><img src="/Public/home/images/cart.jpg" align="absmiddle" />我的购物车</span><em></em></div>
			<ul class="shop_b">
			...
			<?php if(is_array($items)): foreach($items as $k=>$i): ?><ul class="ulcart">
				<li class="shop_num"><?php echo ($k); ?></li>
				<li class="shop_pic">
					<div class="promin_mainpic">
						<div class="promin_mainpicn">
						<a href="goods.php?id=32" target="_blank"></a><br />
						<i></i>
						</div>
					</div>
				</li>
				<li class="shop_name">
					 <a href="goods.php?id=32" target="_blank"><?php echo ($i["goods_name"]); ?></a>
				</li>
				<li class="shop_color">&nbsp;</li>
				<li class="shop_nu">
										<img src="/Public/Home/images/bag_close.gif" onclick="decrCart()" />
                                        <input type="text" name="goods_number[44]" class="input_num" id="goods_number_44" value="<?php echo ($i["num"]); ?>" size="4" style="text-align:center" readonly="true" />
                                        <img src="/Public/Home/images/bag_open.gif" onclick="addCart()" />
									</li>
				<li class="shop_much">￥<?php echo ($i["shop_price"]); ?>元</li>
				<li class="shop_sum">￥3010.00元</li>
				<li class="shop_oper">
				<a href="<?php echo U("flow/del?id=$k");?>" class="f6">删除</a>
			...
			<div class="shop_bot">
				...
				<span class="right">
					...
					<input type="button" value="继续购物" class="button_shop" style="cursor:pointer" onClick="location.href='<?php echo U('home/index/index');?>';">
					<input type="button" value="开始结算" style="cursor:pointer" class="buttonredb" onClick="if (1==0) {alert('您还没有添加商品，无法进行结算。');return;}window.location.href='<?php echo U('flow/flow_checkout');?>'">
				</span>
