...
<div class="position">
    ...
    <span>
        ...
        <?php if(is_array($family)): foreach($family as $key=>$f): ?><a href="<?php echo U('category', array('id'=>$f[cat_id]));?>">
            <?php echo ($f["cat_name"]); ?>
        </a>      
        <code>
            &gt;
        </code><?php endforeach; endif; ?>
...
<div id="detail_body">
    <div class="detail_l">
        <div class="detail_pic">
            <a href="javascript:;" onclick="window.open('gallery.php?id=9'); return false;">
                <img src="/Public/uploads/<?php echo ($goods["goods_img"]); ?>" alt="诺基亚E66"
 ...
 <div class="detail_smallpic_header">
			<a href="javascript:" onmousedown="clickRight()" onmouseout="scrollStop()">
				...
				<img src="/Public/Home/images/detail_header.gif" border="0">
			</a>
		</div>
		<div id="demo" class="detail_smallpic_body">
				...
				<ul>
					<li>
						<a href="gallery.php?id=9&amp;img=14" target="_blank">
							<img onmouseover="img_src('/Public/Home/images/17_P_1241969394354.jpg')" alt="诺基亚E66" src="/Public/Home/images/17_thumb_P_1241969394537.jpg" alt="诺基亚E66" width="81" />
            ...
            <div class="detail_smallpic_footer">
                ...
                onmouseout="scrollStop()">
                    <img src="/Public/Home/images/detail_footer.gif" border="0">
                </a>
            </div>
        </div>
        <div class="clear">
    ...
    <div class="detail_r">
        ...
        <div style="width: 100%; padding-top: 10px;">
                ...
                <ul style="border-bottom: medium none;">
                    <li style="width: 260px; float: left; margin-right: 10px; margin-top: 5px;">
                        ...
                        <span style="text-decoration: line-through;">
                            ￥<?php echo ($goods["market_price"]); ?>元
                        </span><br />
                        本店售价：：
                        <span>
                            <font color="red">￥<?php echo ($goods["shop_price"]); ?>元</font>
                        </span>
                    </li>
            ...
            <div style="margin-top:30px;"><a href="<?php echo U('flow/buy', array('id'=>$goods['goods_id']));?>"><img src="/Public/Home/images/member_shop.gif" /></a></div>
    ...
    <div class="clear detail_body_footer">
        <div style="border: 1px solid rgb(204, 204, 204); background: transparent url(/Public/Home/images/ad/ads03.jpg) repeat scroll 0% 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; width: 885px; height: 71px; color: rgb(102, 102, 102);">
        ...
        <div class="detail_info_l_body">
            ...
            <div id="ECS_COMMENT">
                <div class="det_review">
                    <form action="<?php echo U('home/goods/goods',array('id'=>$goods['goods_id']));?>" onsubmit="submitComment(this)" method="post"
                ...
                <?php if(is_array($comms)): foreach($comms as $key=>$c): ?><div class="review">
                    <div class="rev_t">
                        ...
                        <div class="rev_t_time"><strong>时间：</strong><?php echo (date("Y-m-d H:i:s",$c["pubtime"])); ?></div>
                        <div class="clear"></div>
                    </div>
